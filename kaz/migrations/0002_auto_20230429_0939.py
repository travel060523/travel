...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL("""CREATE VIEW view_hotel AS
                        SELECT hotel.id, country.title AS country, region.title AS region, hotel.title, hotel.details, hotel.photo, hotel.price, (SELECT AVG(rating) FROM reviews WHERE reviews.hotel_id = hotel.id) AS avg_rating 
